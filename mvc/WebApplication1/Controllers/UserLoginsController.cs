...
namespace Restaurant.Controllers
{
    public class UserLoginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Passwordd,RoleId,CustomerId")] UserLogin userLogin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,UserName,Passwordd,RoleId,CustomerId")] UserLogin userLogin)
        {
            if (id != userLogin.Id)
            {
                return NotFound();
