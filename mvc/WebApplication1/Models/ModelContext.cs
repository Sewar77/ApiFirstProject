...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseOracle("Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=localhost)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=orcl)));User Id=Sewar77;Password=Test321;");


    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder
            .HasDefaultSchema("SEWAR77")
            .UseCollation("USING_NLS_COMP");

        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("SYS_C007941");
        ...
        {
            entity.HasKey(e => e.Id).HasName("SYS_C007945");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("SYS_C007947");
        ...
        {
            entity.HasKey(e => e.ProductCustomerId).HasName("SYS_C007953");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.ProductCustomers)
                ...
                .HasConstraintName("FK_PC_CUSTOMER");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("SYS_C007943");
        ...
        {
            entity.HasKey(e => e.Id).HasName("SYS_C007950");
