...
namespace FitnessLife.Controllers
{
    public class MembershipplansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Planid,Planname,Durationinmonths,Price,Description,Createdat")] Membershipplan membershipplan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Planid,Planname,Durationinmonths,Price,Description,Createdat")] Membershipplan membershipplan)
        {
